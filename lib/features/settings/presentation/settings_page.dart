      ...
      body: ListView(
        ...
        children: const [
          SectionCard(
            ...
            child: Text(
              '支持 Android USB OTG 与桌面 COM/tty 设备。常见芯片包括 CH340、FTDI、CP210x、CDC ACM。',
            ),
          ),
          SizedBox(height: 20),
          SectionCard(
          ...
          SectionCard(
            title: '平台注意事项',
            child: Text(
              'Android 需要摄像头、麦克风与 USB Host 权限。桌面端需要摄像头权限以及系统串口驱动。Linux 可能需要将用户加入 dialout/uucp 等串口权限组。',
            ),
          ),
        ],
      ),
